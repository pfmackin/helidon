...
Application metrics must be created and registered in the application MetricRegistry.  The registry
...
To summaryize, this guide demonstrated how to use metrics in a Helidon MP application:

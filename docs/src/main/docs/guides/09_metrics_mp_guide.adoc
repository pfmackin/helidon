...
==== Non-injected annotated metrics

Certain metrics, like Gauge, cannot be automatically injected into a managed object, but you can still use annotion so
that Helidon registers the metric in the MetricRegistry.

...
methods as described in <<03_hierarchical-features, Hierarchical Configuration>>.  This simple example below demonstrates how
to access a child node as a detached configuration sub-tree.
